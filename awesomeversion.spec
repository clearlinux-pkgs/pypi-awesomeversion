...
%prep
%setup -q -n awesomeversion-21.5.0
cd %{_builddir}/awesomeversion-21.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622670417
...
cp %{_builddir}/awesomeversion-21.5.0/LICENCE.md %{buildroot}/usr/share/package-licenses/awesomeversion/cac557ec31c1200997ba103929b2ba901c9a3ed3

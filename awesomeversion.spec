...
%prep
%setup -q -n awesomeversion-21.10.1
cd %{_builddir}/awesomeversion-21.10.1
...
cp %{_builddir}/awesomeversion-21.10.1/LICENCE.md %{buildroot}/usr/share/package-licenses/awesomeversion/cac557ec31c1200997ba103929b2ba901c9a3ed3

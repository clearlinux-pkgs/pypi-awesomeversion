...
Version  : 25.5.0
Release  : 51
URL      : https://files.pythonhosted.org/packages/5e/95/bd19ef0ef6735bd7131c0310f71432ea5fdf3dc2b3245a262d1f34bae55e/awesomeversion-25.5.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/5e/95/bd19ef0ef6735bd7131c0310f71432ea5fdf3dc2b3245a262d1f34bae55e/awesomeversion-25.5.0.tar.gz
...
%prep
%setup -q -n awesomeversion-25.5.0
cd %{_builddir}/awesomeversion-25.5.0
pushd ..
cp -a awesomeversion-25.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748527837

...
%prep
%setup -q -n awesomeversion-22.4.0
cd %{_builddir}/awesomeversion-22.4.0
...
cp %{_builddir}/awesomeversion-22.4.0/LICENCE.md %{buildroot}/usr/share/package-licenses/pypi-awesomeversion/daddaad606932154118c232a147f4c0c867bb5cf
